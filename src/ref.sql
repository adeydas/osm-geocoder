...
create index IDX0_TIGER on TIGER(tlid);
create index IDX1_TIGER on TIGER(fename);
create index IDX2_TIGER on TIGER(fraddL);
create index IDX3_TIGER on TIGER(toaddL);
create index IDX4_TIGER on TIGER(fraddR);
create index IDX5_TIGER on TIGER(toaddR);
create index IDX6_TIGER on TIGER(zipL);
create index IDX7_TIGER on TIGER(zipR);
