 ...
 */
public class RouteGeometryTypeImpl extends net.opengis.xls.impl.AbstractDataTypeImpl implements net.opengis.xls.RouteGeometryType
{
    
    public RouteGeometryTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
