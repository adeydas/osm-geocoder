...
public class JGeocoderConfig implements Serializable{
  ...
  private String _jgeocoderDataHome = CommonUtils.nvl(System.getProperty("jgeocoder.data.home"), "/usr/local/jgeocoder/data");
  ...
  public synchronized DataSource getTigerDataSource() {
    if(_tigerDataSource == null){
      _tigerDataSource = DatabaseUtils.getDataSource();
    }
